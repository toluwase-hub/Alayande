    ...
    <div className="py-3">
      ...
      <Marquee pauseOnHover={true}>
        <div className="flex justify-center items-center gap-2 pt-10">
          ...
          />
          <img
            src="../src/assets/Components/imgi_6_1747730882_evt.png"
            className="w-100 h-60 object-cover rounded-lg "
            alt=""
          />
          <img
      ...
      <Marquee pauseOnHover="true" direction="right">
        <div className="flex justify-center items-center gap-2 py-2">
          ...
          />
          <img
            src="../src/assets/Components/whats-5.jpeg"
            className="w-100 h-60 object-cover rounded-lg "
            alt=""
          />
          <img
            src="../src/assets/Components/whats-6.jpeg"
            className="w-100 h-60 object-cover rounded-lg "
            alt=""
          />
          <img
            src="../src/assets/Components/whats-7.jpeg"
            className="w-100 h-60 object-cover rounded-lg "
            alt=""
          />
          <img
            src="../src/assets/Components/whats-9.jpeg"
            className="w-100 h-60 object-cover rounded-lg me-2  "
            alt=""
          />
        </div>
